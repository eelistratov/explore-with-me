 ...
 * Ошибки обращения к stats-сервису логируются, но не пробрасываются наружу:
 * статистика — некритичный поток данных, её недоступность не должна
 * ломать основной сценарий работы сервиса.
 */
@Slf4j
@Component
